...
/*
 Graph is an ADT in computer science
 
 Graph basically contains
 1. Vertices (nodes)
 2. Edges (arrows)
 
 The edges can 3 types
 1. Weighted
...
//extension Vertex : Never where T:Never{}
...
/*
 ...
 The Adjacent List
    ...
    Tokyo --> Singapore, Detroit , Hongkong, Washington
    Detroit --> Tokyo
    Washington --> Tokyo
 */
